...
public:
    ...
    // From IDA: Console command handler override
...
private:
    // From IDA: Game state (Normal=0, RepairGame, etc.)
    UPROPERTY()
    EFNAFGameState CurrentState;

    // From IDA: Debug AI display toggle
    UPROPERTY()
    bool bCurrentAIDisplay;
};